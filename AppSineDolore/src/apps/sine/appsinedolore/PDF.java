...
public class PDF extends Analytics {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// FIN DE ANTERIOR VERSIÓN - No funciona. Descarga pero se queda en
		// blanco.
	...
	private void CopyReadAssets() {
		...
		OutputStream out = null;// donde lo soltará
		...
		try {
			...
			Toast.makeText(PDF.this, "No hay aplicación lectora de PDFs",
					Toast.LENGTH_LONG).show();
		}
