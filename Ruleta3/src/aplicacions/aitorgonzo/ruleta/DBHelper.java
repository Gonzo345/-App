...
public class DBHelper extends SQLiteOpenHelper {
	...
	public final static String KEY_FECHA = "fecha";
	// Array de strings para su uso en los diferentes métodos
	private static final String[] cols = new String[] { KEY_ID, KEY_NUM,
			KEY_FECHA };

	// Ruta por defecto de las bases de datos en el sistema Android
	private static String DB_PATH = "/data/data/aplicacions.aitorgonzo.ruleta/databases/";
	private static String DB_NAME = "ruletadb";
	private SQLiteDatabase RuletaDB;
	...
	public void open() throws SQLException {
		...
		String myPath = DB_PATH + DB_NAME;
		RuletaDB = SQLiteDatabase.openDatabase(myPath, null,
				SQLiteDatabase.OPEN_READONLY);
	...
	public void insertar(int id_ruleta, String numsel, String fecha) {
		RuletaDB.execSQL("INSERT INTO ruleta VALUES ('" + id_ruleta + "','"
				+ numsel + "','" + fecha + "') ");
	}

	public void eliminar() {
		// Eliminar un registro
		// RuletaDB.execSQL("DELETE FROM id_ruleta WHERE codigo=6 ");
	}

	public void actualitzar() {
		// Actualizar un registro
//		RuletaDB.execSQL("UPDATE Usuarios SET nombre='usunuevo' WHERE codigo=6 ");
	}

	public void select() {
		String[] campos = new String[] { "id_ruleta", "num", "fecha" };
		String[] args = new String[] { "usu1" };

		Cursor c = RuletaDB.query("Id_ruleta", campos, "nombre=?", args, null,
				null, null);
		...
		if (c.moveToFirst()) {
			...
			do {
				String id_ruleta = c.getString(0);
